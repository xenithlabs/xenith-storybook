import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{r as c}from"./index-DRjF_FHU.js";import{C as r}from"./Card-C5rr-ZzX.js";import{H as f}from"./Heading-DjlBwQyS.js";import{T as a}from"./Text-C8HBwI4b.js";import{B as se}from"./Badge-TrTt3KrN.js";import{B as re}from"./Button-CHcYOyT5.js";import"./cn-8RyR4BqC.js";import"./index-HZDBD2ik.js";import"./index-Bb4qSo10.js";import"./styles-x1yxmyQd.js";import"./Icon-CTnhpE1d.js";import"./spinner-ojW7ALd7.js";import"./chevron-down-CyV3wpL8.js";const l=({children:n,fallback:s})=>{const t=c.useRef(null),[i,le]=c.useState(!1),[ie,ce]=c.useState(!0);return c.useLayoutEffect(()=>{if(t.current){const oe=(t.current.innerText||t.current.textContent||"").trim().length>0;le(!oe),ce(!1)}},[n]),ie?e.jsx("div",{ref:t,style:{position:"absolute",visibility:"hidden",pointerEvents:"none",left:"-9999px"},children:n}):i?e.jsx(e.Fragment,{children:s}):e.jsx(e.Fragment,{children:n})};l.__docgenInfo={description:"",methods:[],displayName:"EmptyChildFallback",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},fallback:{required:!0,tsType:{name:"ReactNode"},description:""}}};const We={title:"Xenith UI/Components/EmptyChildFallback",component:l,tags:["autodocs"],parameters:{docs:{description:{component:`
## Overview
