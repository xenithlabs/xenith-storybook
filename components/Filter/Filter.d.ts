...
import { ComponentPropsWithoutRef, HTMLAttributes } from '../../../node_modules/react';
...
declare const FilterHeader: ({ children, className, }: HTMLAttributes<HTMLDivElement>) => import("react/jsx-runtime").JSX.Element;
