import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{r as i}from"./index-DRjF_FHU.js";import"./mini-FlV67GHA.js";import{t as De}from"./index-CXogW5Rw.js";import{c as ge}from"./cn-8RyR4BqC.js";import{I as he}from"./Icon-CTnhpE1d.js";import{F as Se}from"./calendar-C26CUINT.js";import{P as Ce,a as Ne,b as je}from"./Popover-A4hNnO1p.js";import{C as we,T as z}from"./Calendar-DDUm24ok.js";import{B as m}from"./Button-CHcYOyT5.js";import{f as u,s as Te}from"./format-DX5nf6U1.js";import{F as ke}from"./clock-DRhx3Wks.js";import{a as D}from"./startOfMonth-CZilhnlQ.js";import{T as n}from"./Text-C8HBwI4b.js";import{C as p}from"./Card-C5rr-ZzX.js";import{H as b}from"./Heading-DjlBwQyS.js";import{D as ve}from"./Divider-CIm89-oy.js";import{s as F}from"./subDays-DGkdSj43.js";import{e as ye}from"./endOfDay-irTNPJGS.js";import{B as be}from"./Badge-TrTt3KrN.js";import"./index-Bb4qSo10.js";import"./index-DuXoWBk8.js";import"./index-CxRLcT2J.js";import"./index-DdILnG7L.js";import"./index-Bq6ilrdN.js";import"./index-qtGI3euC.js";import"./index-CxZrjbHI.js";import"./floating-ui.dom-BuxmzwbT.js";import"./index-KY2xTor3.js";import"./index-BhXpUKZt.js";import"./toDate-SX-ecmdR.js";import"./styles-x1yxmyQd.js";import"./chevron-left-D0P6BdMN.js";import"./chevron-right-D4FvqfWr.js";import"./index-HZDBD2ik.js";import"./spinner-ojW7ALd7.js";import"./chevron-down-CyV3wpL8.js";const r=({date:a,fromDate:s,toDate:t,onChange:o,error:l,timezone:c="UTC",...d})=>{const[x,P]=i.useState(a),fe=i.useMemo(()=>{if(s&&t)return{before:s,after:t};if(s)return{before:s};if(t)return{after:t}},[s,t]);return i.useEffect(()=>{P(a)},[a]),e.jsxs(Ce,{children:[e.jsx(Ne,{asChild:!0,children:e.jsx(m,{variant:"outline",theme:"neutral",className:ge("justify-start text-left font-normal items-center",!x&&"text-muted-foreground",{"border-border-critical":l}),icon:e.jsx(he,{icon:e.jsx(Se,{})}),children:x?u(x,"dd MMM yyy",{in:De(c)}):e.jsx("div",{className:"text-text-weaker",children:d.placeholder??"Pick a date"})})}),e.jsx(je,{className:"w-auto p-0",children:e.jsx(we,{timeZone:c,mode:"single",disabled:fe,startMonth:s,endMonth:t,selected:x,defaultMonth:x,onSelect:M=>{P(M),o&&o(M)},autoFocus:!0})})]})};r.__docgenInfo={description:"",methods:[],displayName:"DatePicker",props:{date:{required:!1,tsType:{name:"Date"},description:""},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(date?: Date) => void",signature:{arguments:[{type:{name:"Date"},name:"date"}],return:{name:"void"}}},description:""},fromDate:{required:!1,tsType:{name:"Date"},description:""},toDate:{required:!1,tsType:{name:"Date"},description:""},error:{required:!1,tsType:{name:"boolean"},description:""},timezone:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"UTC"',computed:!1}}},composes:["Omit"]};const pa={title:"Xenith UI/Components/Date Picker",component:r,decorators:a=>e.jsx("div",{className:"py-10 w-[300px] h-[400px]  pb-40",children:e.jsx(a,{})}),tags:["autodocs"],parameters:{docs:{description:{component:`
## Overview
