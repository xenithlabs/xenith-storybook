import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{r as N,R as O}from"./index-DRjF_FHU.js";import{c as Ne}from"./index-Bb4qSo10.js";import{c as Be}from"./cn-8RyR4BqC.js";import{B as a}from"./Badge-TrTt3KrN.js";import{F as Ae}from"./check-circle-DNKzEdhW.js";import{F as je}from"./clock-DRhx3Wks.js";import{F as ye}from"./info-Cre7IJy9.js";import{F as we}from"./alert-circle-Fx72cPit.js";import"./styles-x1yxmyQd.js";const Ce=({children:s,maxVisible:n,gap:c})=>{const o=N.useRef(null),[I,m]=N.useState(0),[D,u]=N.useState(0),[T,b]=N.useState(!0);return N.useEffect(()=>{const l=()=>{if(!o.current)return;const V=o.current,f=O.Children.toArray(s),g=f.length;if(n&&n<g){m(n),u(g-n),b(!1);return}const k=V.offsetWidth;if(k===0){requestAnimationFrame(l);return}const d=document.createElement("div");d.style.cssText=`
        position: absolute;
        top: -9999px;
        left: -9999px;
        visibility: hidden;
