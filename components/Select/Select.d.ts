...
declare const SelectBaseStyles: ({ size, noBorder, noBorderHeightAdjusted, error, readonly, readOnlyWithCheck, optionBorder, isDisabled, menuClassName, }?: BaseStylesProps) => {
