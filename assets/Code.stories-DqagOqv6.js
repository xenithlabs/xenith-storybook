import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{c as y}from"./cn-C-5SdYIA.js";import"./index-DRjF_FHU.js";const x=({children:f,className:b})=>{const n=f.split(`
`);return e.jsx("div",{className:y("font-mono text-sm bg-bg-weaker rounded-radius-sm overflow-hidden border border-default text-text-weak",b),children:e.jsx("pre",{className:"relative",children:e.jsxs("div",{className:"flex",children:[e.jsx("div",{className:"py-4 leading-[26px] pl-4 pr-4 text-neutral select-none bg-bg-weaker border-r border-border-default",children:n.map((s,t)=>e.jsx("div",{className:"text-center text-text-weak ",children:t+1},t+1))}),e.jsx("div",{className:"py-4 px-4 overflow-auto ",children:n.map((s,t)=>e.jsx("div",{className:"whitespace-pre leading-[26px] text-text-weak",children:s||" "},t))})]})})})};x.__docgenInfo={description:"",methods:[],displayName:"Code",props:{children:{required:!0,tsType:{name:"string"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const S={title:"Xenith UI/Components/Code",component:x,tags:["autodocs"]},o={args:{children:`POST /webhook-endpoint HTTP/1.1
